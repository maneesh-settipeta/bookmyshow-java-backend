package com.example.BookMyShow.entitygenerator;
...
public class EntityGenerator {
	...
	public EntityGenerator() {
		try {
			...
			con = DriverManager.getConnection("jdbc:postgresql://localhost:5432/bookmyshow", "postgres", "Manu$123");
